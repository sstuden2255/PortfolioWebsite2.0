 ...
 * All icons are decorative: they render with aria-hidden and rely on
 * the parent link/button to carry the accessible label.
 */
...
export function LinkedInIcon({ size = 20 }: IconProps) {
  return (
    <svg {...svgProps(size)}>
      <path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4V9h4v1.5A5.8 5.8 0 0 1 16 8z" />
...
/* Store marks are solid glyphs, so they fill instead of stroke. */
